...
from learning_truncated_binomial_algos.system_solution \
import learn_truncated_binomial_system_solution
...
for i in range(3):
  for j in range(3):
      ...
      #estimation
      (n_est, p_est), samples =\
        learn_truncated_binomial_system_solution(N, true_dist, S, a, epsilon=epsilon, printing=2)
