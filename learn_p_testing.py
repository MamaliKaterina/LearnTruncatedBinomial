...
from learn_p_PSGD import learn_p_PSGD
...
for i in range(3):
  for j in range(3):
      ...
      #estimation
      (n_est, p_est), samples =\
        learn_p_PSGD(true_dist, S, a, epsilon=epsilon, printing=2)
      print('Final Samples', samples)
      print('Parameters Estimation', int(n_est), round(p_est, 5))
